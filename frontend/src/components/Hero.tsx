    ...
    <section className="min-h-screen flex items-center justify-center px-4 pt-16">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8 relative">
          ...
          <button
            onClick={handleUploadClick}
            className={`absolute -bottom-2 -right-2 w-8 h-8 bg-gradient-to-r ${currentTheme.primary} rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300`}
